#!/usr/bin/env python3
"""训练TCN基线模型 - 从experiment.yaml读取配置"""
...
# Import from coughcount package
...
def main() -> None:
    ...
    count_loss_mode = str(train_cfg.get("count_loss_mode", "mae"))
    count_rel_eps = float(train_cfg.get("count_rel_eps", 1.0))
    ...
    for epoch in range(start_epoch, components.epochs + 1):
        ...
        for batch in pbar:
            ...
            loss = train_loss_weighted(
                ...
                count_loss_mode=count_loss_mode,
                count_rel_eps=count_rel_eps,
